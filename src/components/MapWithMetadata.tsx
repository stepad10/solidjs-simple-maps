...
export default function MapWithMetadata(props: MapWithMetadataProps) {
    ...
    const [local, mapProps] = splitProps(merged, [
        'metadata',
        'enableSEO',
        'enableOpenGraph',
        'enableTwitterCards',
    ...
    const processedMetadata = createMemo(() => {
        ...
        return {
            ...
            ogTitle: local.enableOpenGraph
                ? local.metadata.title || resolvedPresetData.ogTitle
                : undefined,
            ogDescription: local.enableOpenGraph
                ? local.metadata.description || resolvedPresetData.ogDescription
                : undefined,
            twitterTitle: local.enableTwitterCards
                ? local.metadata.title || resolvedPresetData.twitterTitle
                : undefined,
            twitterDescription: local.enableTwitterCards
                ? local.metadata.description || resolvedPresetData.twitterDescription
                : undefined,
